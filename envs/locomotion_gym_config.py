...
class SimulationParameters(object):
    enable_rendering = attr.ib(type=bool, default=False)  # whether to show the interface. COV_ENABLE_RENDERING
    enable_rendering_gui = attr.ib(type=bool, default=False)  # COV_ENABLE_GUI
